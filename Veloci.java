...
/**
 * Write a description of class Veloci here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class Veloci extends Dinosaur
{
    // instance variables - replace the example below with your own
    

    /**
     * Constructor for objects of class Veloci
     */
    public Veloci()
    {
        //super() --> must be the first line of a constructor
        super("Veloci"); // Calls the explicit constructor of the parent class
